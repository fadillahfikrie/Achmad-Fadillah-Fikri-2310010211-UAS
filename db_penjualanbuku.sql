...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jan 2026 pada 13.18
...
(4, 'Petualangan si Royan', 'Fikri', 'UPT', 100000, 200),
(5, 'operasi ku', 'royan', 'fikfik', 100000, 12),
(7, 'Robat Kami', 'Ucok', 'Well Well', 200000, 20);
...
INSERT INTO `detail_penjualan` (`id_detail`, `id_penjualan`, `id_buku`, `jumlah`, `subtotal`) VALUES
(3, 5, 4, 90000, 9000000000);
...
(5, 'Royan', 'Jl. Yondaktau', '0865443212'),
(6, 'Rahman', 'Jl. Perumahan', '08312234567'),
(7, 'Rania', 'Jl. Ujung ', '0821456790'),
(8, 'Tina', 'Jl. Pohon', '0873212345');
...
ALTER TABLE `detail_penjualan`
  ...
  ADD CONSTRAINT `detail_penjualan_ibfk_2` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`) ON UPDATE CASCADE;
